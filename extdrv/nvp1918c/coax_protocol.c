...
void vdec_coaxial_select_ch(unsigned int ch)
{
	...
	gpio_i2c_write( NVP1918C+i, 0x8B, ch);
}
...
void vdec_coaxial_init(void)
{
	int i = 0;
	gpio_i2c_write( NVP1918C+i, 0xFF, 0x01);
	gpio_i2c_write( NVP1918C+i, 0xBC, 0xDD);
	gpio_i2c_write( NVP1918C+i, 0xBD, 0xDD);
	gpio_i2c_write( NVP1918C+i, 0xBE, 0xDD);
	gpio_i2c_write( NVP1918C+i, 0xBF, 0xDD);
	//gpio_i2c_write( NVP1918C+i, 0x8B, 0x00);
}
