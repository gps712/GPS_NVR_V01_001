...
//		gpio_i2c_write(dec, 0x23, 0x10);  // Audio playback out
	...
	gpio_i2c_write(dec, 0x01, 0x08);  // ch1 Audio input gain init
	gpio_i2c_write(dec, 0x02, 0x08);
	gpio_i2c_write(dec, 0x03, 0x08);
	gpio_i2c_write(dec, 0x04, 0x08);
	gpio_i2c_write(dec, 0x05, 0x08); //mic gain
	gpio_i2c_write(dec, 0x40, 0x08);  //ch5 
	gpio_i2c_write(dec, 0x41, 0x08);
	gpio_i2c_write(dec, 0x42, 0x08);
	gpio_i2c_write(dec, 0x43, 0x08);
	gpio_i2c_write(dec, 0x22, 0x08);  //aogain
