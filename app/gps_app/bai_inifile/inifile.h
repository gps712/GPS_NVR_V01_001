...
int read_profile_string_buf( const char *section, const char *key,char *value, int size, const char *default_value, char *buf);
int write_profile_string_buf(const char *section, const char *key,const char *value, char *buf);
int read_profile_write_buf( const char *section, const char *key,char *value, int size, const char *default_value, char *buf);
